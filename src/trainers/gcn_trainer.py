...
def train_gcn_on_dataset(
    ...
    for i in range(len(seeds)):
        ...
        if run_config.parse_communication_results:
            ...
            with open(f"comm_results/{dataset}_gcn.json") as f:
            ...
            with open(f"comm_results/{dataset}_gcn_with_server.json") as f:
            ...
            with open(f"comm_results/{dataset}_size_mmlp_gcn_nl_2.json") as f:
                comm_size_mmlp = json.load(f)
                
            with open(f"comm_results/{dataset}_size_mmlp_gcn_nl_2_with_server.json") as f:
            ...
            with open(f"comm_results/{dataset}_sorted_size_gcn.json", "w") as f:
                json.dump(sorted_comm_size, f, indent = 4)
            
            with open(f"comm_results/{dataset}_sorted_size_mmlp_gcn.json", "w") as f:
            ...
            f = csv.writer(open(f'comm_results/plot_values_gcn_{dataset}.csv', 'w', encoding='utf8'))
            f.writerow(['S_no', 'node'])
            
            for a, node in enumerate(sorted_comm_size):
                f.writerow([a, sorted_comm_size[node]])
                
            p = csv.writer(open(f'comm_results/plot_values_mmlp_gcn_{dataset}.csv', 'w', encoding='utf8'))
